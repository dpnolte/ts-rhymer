...
private class ValueTypeTransformer (val predicate: (type: WrappedType) -> Boolean, val type: String)
private class NameTypeTransformer (val tranformer: (type: WrappedType) -> String )
